...
export const ChatContextProvider = ({ fileId, children }: ChatContextProvider) => {
  ...
  const { mutate: sendMessage } = useMutation({
    ...
    onMutate: async ({ message }) => {
      ...
      // Step 1: Cancel all outgoing refetch, so will not overwrite optimistic update
      await utils.getFileMessages.cancel();

      // Step 2: Snapshot prev values we have
      const previousMessages = utils.getFileMessages.getInfiniteData();

      // Step 3: Immediately insert msg after send it
